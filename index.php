                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>₹</span><strong>350</strong><span>.00</span></h2>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span></span><strong>750</strong><span>.00</span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (₹350.00)</option>
                 <option value="2">PREMIUM CLEANING (₹500.00)</option>
                  <option value="3 ">COMPLEX CLEANING(₹750.00)</option>
              </select>
